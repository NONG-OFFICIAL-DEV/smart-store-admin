...
class OrderExportController extends Controller
{
    ...
    {
        // resolveOrNull(), not resolve() — a super admin exporting across
        // every tenant (see the !is_super_admin check below) legitimately
        // sends no tenant_id at all; resolve() would abort(403) before
        ...
        foreach ($orders as $order) {
            foreach ($order->items as $item) {
                ...
                $data = [
                    ...
                    (float) (($item->unit_price ?? 0) * $item->quantity),
                    $item->note ?? '',
                ];

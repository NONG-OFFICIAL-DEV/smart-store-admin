...
class StockAdjustmentController extends Controller
{
    ...
    public function adjust(Request $request)
    {
        ...
        return DB::transaction(function () use ($request) {
            // Lock the product row so a concurrent adjustment/sale can't read
            // stale stock and race with this update.
            ...
            if ($isCount) {
                // count: set absolute value — convert through the selected unit
                // just like adjustment_in/out, so a count taken in e.g. "boxes"
                // is stored correctly in the product's base unit.
                $qtyAfter = $baseQty;

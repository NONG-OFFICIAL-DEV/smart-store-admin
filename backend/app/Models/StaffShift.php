...
class StaffShift extends BaseModel
{
    ...
    public function getStatusAttribute(): string
    {
        ...
        $scheduledStart = \Carbon\Carbon::parse(
            $this->shift_date->toDateString() . ' ' . $this->shift->start_time
        );
    ...
    public function getActualMinutesAttribute(): ?int
    {
        ...
        $gross = abs($this->actual_start->diffInMinutes($this->actual_end));
        return $gross - ($this->shift->break_minutes ?? 0);
    }
    ...
    public function getScheduledEndAttribute(): \Carbon\Carbon
    {
        $end = \Carbon\Carbon::parse(
            $this->shift_date->toDateString() . ' ' . $this->shift->end_time
        );

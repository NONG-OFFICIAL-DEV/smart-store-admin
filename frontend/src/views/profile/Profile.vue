    ...
    <template v-else>
      <v-row class="ga-y-6">
        ...
        <v-col cols="12" md="8">
          ...
          <!-- Security — self-service change password + email, side by side
               (available to every authenticated user regardless of tenant load state) -->
          <v-card class="pa-6 mt-2" rounded="lg">
            <div class="mb-5">
              <h3 class="text-subtitle-1 font-weight-bold text-high-emphasis">

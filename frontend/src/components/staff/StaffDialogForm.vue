                  ...
                  <v-card rounded="lg" border elevation="0" class="pa-4 mb-3">
                    ...
                    <v-row dense>
                      ...
                      <v-col cols="6">
                        ...
                        <div class="text-body-2 font-weight-medium">
                          {{
                            assignableRoles.find(ro => ro.id === form.role_id)
                              ?.name ?? '—'
                          }}
                        </div>
                      </v-col>
...
<script setup>
  ...
  const confirmResetPassword = () => {
    confirm({
      ...
      agree: async () => {
        try {
          temporaryPassword.value = await staffStore.resetPassword(
            props.item.id
          )
  ...
  const submit = async () => {
    ...
    emit('save', {
      ...form,
      hire_date:
        form.hire_date instanceof Date

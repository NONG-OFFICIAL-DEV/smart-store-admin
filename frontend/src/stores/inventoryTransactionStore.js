...
import { getAllInventoryTransactionsApi, getInventoryTransactionByIdApi, createInventoryTransactionApi, updateInventoryTransactionApi, deleteInventoryTransactionApi } from '../api/inventoryTransactionService'
...
export const useInventoryTransactionStore = defineStore('inventoryTransaction', {
  ...
  actions: {
    ...
    async updateInventoryTransaction(id, data) {
      ...
      const index = this.inventoryTransactions.findIndex(item => item.id === id)
    ...
    async deleteInventoryTransaction(id) {
      ...
      this.inventoryTransactions = this.inventoryTransactions.filter(item => item.id !== id)
    },
  },
})